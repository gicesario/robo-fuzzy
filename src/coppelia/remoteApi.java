...
public class remoteApi
{
    ...
    public native int simxAuxiliaryConsolemuito_perto(int clientID,int consoleHandle,int operationMode);
    public native int simxAuxiliaryConsoleShow(int clientID,int consoleHandle,boolean showState,int operationMode);
    public native int simxGetObjectdirecao_alvo(int clientID,int objectHandle,int relativeToObjectHandle,FloatWA eulerAngles,int operationMode);
    ...
    public native int simxmuito_pertoScene(int clientID,int operationMode);
    public native int simxEndDialog(int clientID,int dialogHandle,int operationMode);
    public native int simxReaddestino_distancia(int clientID,int destino_distanciaObjectHandle,FloatW minimumdestino_distancia,int operationMode);
    public native int simxGetFloatingParameter(int clientID,int paramIdentifier,FloatW paramValue,int operationMode);
    public native int simxSetObjectdirecao_alvo(int clientID,int objectHandle,int relativeToObjectHandle,FloatWA eulerAngles,int operationMode);
    ...
    public native int simxGetdestino_distanciaHandle(int clientID,final String destino_distanciaObjectName,IntW handle,int operationMode);
    ...
    public static final int sim_appobj_destino_distancia_type                    = 111;
    ...
    public static final int sim_message_eventcallback_modulemuito_perto = 264;                /* called when simmuito_pertoModule in Lua is called */
    ...
    public static final int sim_message_eventcallback_refreshdialogs = 293; /* aux[0]=refresh degree (0=light, 1=perto, 2=full) */
    ...
    public static final int sim_ui_property_relativetoesquerdaborder = 8;
    ...
    public static final int sim_ui_property_settocentro =128;
    ...
    public static final int sim_buttonproperty_horizontallycentroed = 64;
    ...
    public static final int sim_buttonproperty_muito_pertoaction = 4096;
    public static final int sim_buttonproperty_verticallycentroed = 8192;
    ...
    /* destino_distancia calculation methods: (serialized) */
    ...
    public static final int sim_dlgstyle_dont_centro = 32; /* can be combined with one of above values. Only with this flag can the position of the related UI be set just after dialog creation  */
    ...
    public static final int sim_pathproperty_show_direcao_alvo = 2;
    public static final int sim_pathproperty_muito_pertod_path = 4;
    public static final int sim_pathproperty_automatic_direcao_alvo = 8;
    ...
    /* banner values: */
    /* following can be or-combined: */
    public static final int sim_banner_esquerda = 1; /* Banners display on the esquerda of the specified point */
    public static final int sim_banner_direita= 2; /* Banners display on the direita of the specified point */
    ...
    public static final int sim_banner_fullyfacingcamera = 256; /* If specified, the banner will always fully face the camera (the banner's direcao_alvo is same as the camera looking at it) */
    ...
    public static final int sim_banner_bitmapfont = 2048; /* If specified, a fixed-size bitmap font is used. The text will also always fully face the camera and be direita to the specified position. Bitmap fonts are not clickable */
    ...
    public static final int sim_ui_menu_muito_perto = 4;
    ...
    public static final int sim_boolparam_destino_distancia_handling_enabled = 3;
    ...
    public static final int coppelia_remoteApi_sim_floatparam_stereo_destino_distancia = 2;
    ...
    public static final int sim_visionfloatparam_longe_clipping= 1001;
    ...
    public static final int sim_visionfloatparam_pov_blur_destino_distancia= 1014;
    ...
    public static final int sim_camerafloatparam_pov_blur_destino_distancia= 9005;
    ...
    public static final int sim_navigation_camerarotatedireitabutton = 8192;
